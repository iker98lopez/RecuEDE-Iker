...
public class OperacionesEmple extends JDialog {
	private final class ModificarRegistro implements ActionListener {
	...
	private final class BorrarRegistro implements ActionListener {
	...
	private final class ConsultarRegistro implements ActionListener {
	...
	public OperacionesEmple() {
		...
		//Accion boton borrar
		btnBorrar.addActionListener(new BorrarRegistro());
		
		//Accion boton modificar
		btnModificar.addActionListener(new ModificarRegistro());
	}
}
